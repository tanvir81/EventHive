                ...
                <div className="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <div className="form-control w-full md:w-[38%]">
                        <label className="label pl-2 pb-1">
                            <span className="label-text font-semibold text-gray-500 text-xs tracking-wider uppercase">Looking For</span>
                        </label>
                    ...
                    <div className="form-control w-full md:w-[38%]">
                        <label className="label pl-2 pb-1">
                            <span className="label-text font-semibold text-gray-500 text-xs tracking-wider uppercase">Location</span>
                        </label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg className="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
